export const metadata = {
    title: "Solar Overprovisioning",
    date: "2020-11-09",
    lede: "Too cheap to meter power",
    thumb: "",
    hidden: false
}
...
Ramez Naam has a fantastic [post](https://rameznaam.com/2020/05/14/solars-future-is-insanely-cheap-2020/) about this trend.  This Exciting Tech post is written less well than most because really, you should just go read his post and Casey Handmer's [rant](https://caseyhandmer.wordpress.com/2020/06/05/australian-energy-policy-no-vision-too-small/) about Australia neglecting this technology. The one tweak I would make to Naam's post is to mix some hockey sticks in with his asymptotes. Here's [IRENA](https://www.irena.org/publications/2019/May/Renewable-power-generation-costs-in-2018) data on how much solar energy $1 could get you over the last ten years.

![](/images/solar_hockey.svg)

That looks a little scary if you own coal assets, doesn't it? The [Al Dafra](https://www.greentechmedia.com/articles/read/worlds-largest-solar-project-will-also-be-worlds-cheapest) solar installation in Abu Dhabi will sell you energy for $0.0135 per kWh, or 74 kWh per dollar - that's twice the energy you can buy from a coal plant _if they've already paid for the entire plant_, and 7 times the energy you'd get from a coal plant paying for capital depreciation. 
...
However, suppose you invented a new process for producing nitrogen fertilizers from air, water, and an obscene amount of electricity. The equipment required to run your process is fairly cheap, and it turns on and off quickly. It absolutely makes sense for you to turn that process off overnight, and just build extra equipment if your existing install can't meet demand running part-time. That company exists - it's called [Nitricity](https://www.nitricity.co/) and they're deploying their first systems on California farms right now.
