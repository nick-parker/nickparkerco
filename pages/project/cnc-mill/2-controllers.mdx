...
<Im src="bandit.jpg" cap="The original Bandit controller, with its card cage lifted out of the cabinet."/>
...
<Im src="big_stepper.jpg" cap="My Y axis stepper motor, with a hand for scale."/>
