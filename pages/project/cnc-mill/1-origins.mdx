...
<ImSet>
    <Im src="mill_arrival.jpg" cap="The mill arriving on a hired lowboy truck"/>
    <Im src="mill_dirty.jpg" cap="A fairly greasy mill right after placement in the garage."/>
</ImSet>
